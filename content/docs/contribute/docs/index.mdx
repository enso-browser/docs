---
title: Docs
description: Getting started with contributing to the documentation for Enso Browser.
---

This guide will help you get started with contributing to the documentation for Enso Browser. The documentation is crucial for helping users and developers understand and use the project effectively. We use Fumadocs for generating the static documentation site.
...
1. Navigate to the [Enso Browser Documentation Repository](https://github.com/enso-browser/docs).
...
After pushing your changes, go to the original Enso Browser Documentation Repository and submit a pull request:
...
- [Enso Browser Documentation Repository](https://github.com/enso-browser/docs)
...
Thank you for contributing to Enso Browser's documentation! Your contributions help users and developers understand and effectively use the project.
