...
description: How to use Visual Studio Code to contribute to the Enso Browser documentation.
---
import KeyboardShortcut from '@/components/KeyboardShortcut';

Visual Studio Code (VS Code) is a popular and powerful code editor that works well for editing Enso Browser documentation, especially with the right extensions.
...
Using VS Code with the MDX extension provides a robust environment for contributing to the Enso Browser documentation.