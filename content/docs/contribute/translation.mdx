---
title: Translations
description: How to contribute to the translations for Enso Browser.
---

Thank you for your interest in contributing to the translations for Enso Browser! Ensuring that Enso Browser is accessible to users around the world is a key priority, and your contributions help make this possible. This guide will walk you through the process of getting started with translating Enso Browser using Crowdin.
...
## Step 1: Join the Enso Browser Translation Project

1. Visit the [Enso Browser Translation Project on Crowdin](https://crowdin.com/project/enso-browser).
...
- [Enso Browser Translation Project on Crowdin](https://crowdin.com/project/enso-browser)
...
Thank you for helping to make Enso Browser accessible to a global audience! Your contributions are invaluable.
