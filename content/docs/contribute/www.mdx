---
title: Homepage
description: Learn how to set up and contribute to the development of Enso Browser's homepage.
---

This guide will walk you through the steps required to set up and contribute to the development of Enso Browser's homepage. Whether you're fixing bugs, adding new features, or enhancing the design, this guide will help you get started.
...
1. Navigate to the [Enso Browser Website Repository](https://github.com/enso-browser/www).
...
After pushing your changes, go to the original Enso Browser Homepage Repository and submit a pull request:
...
- [Enso Browser Homepage Repository](https://github.com/enso-browser/www)
- [Contribution Guidelines](/contribute)
- [Code of Conduct](/contribute/code-of-conduct)

---

Thank you for contributing to Enso Browser's homepage! Your contributions help make the project better for everyone.
