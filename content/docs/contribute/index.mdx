---
title: Contributing
description: Contributing to Enso Browser
---

import { GlobeIcon, BookAIcon, BookIcon, HammerIcon } from 'lucide-react'
import { GithubInfo } from 'fumadocs-ui/components/github-info';

Thank you for considering contributing to Enso Browser! We appreciate your time and effort in improving this project. The following is a set of guidelines for contributing to Enso Browser. These guidelines are intended to make it easier for you to get involved.
...
- **UI/UX Enhancements**: Improve the user interface or user experience of Enso Browser.
...
<Cards>
  <Card title="desktop" icon={<HammerIcon />} description="Getting Started with Enso Browser Development" href="/contribute/desktop" />
  <Card title="www" icon={<GlobeIcon />} description="Getting Started with Enso's Homepage Development" href="/contribute/www" />
...
- [Desktop Browser App](https://github.com/enso-browser/desktop/issues)
- [Enso's Custom Mods](https://github.com/enso-browser/theme-store)
- [Enso's Homepage Website](https://github.com/enso-browser/www)
- [This documentation Website](https://github.com/enso-browser/docs)
</Callout>
...
By contributing to Enso Browser, you agree that your contributions will be licensed under the [MPL-2.0 License](https://github.com/enso-browser/desktop/blob/main/LICENSE).

---

Thank you for your interest in contributing to Enso Browser! We look forward to your contributions.
