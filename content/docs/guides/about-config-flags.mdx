...
---
These are a variety of settings that can change Zen's appearance, behavior, and more. To access them, go to `about:config` in Enso Browser, and search for the title of the flag. Some of these flags may require a restart to work.
