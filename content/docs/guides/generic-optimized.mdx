...
For Windows and Linux, Enso Browser used to have the option to download optimized builds. These builds utilized AVX2 instructions to improve performance. These builds have been removed because of the following reasons:
...
View original [here](https://github.com/enso-browser/desktop/wiki/Why-have-optimized-builds-been-removed%3F)
