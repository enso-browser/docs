...
Enso's Split View lets you view up to 4 tabs side by side, so you can compare information or multitask easily.
...
Enso also provides keyboard shortcuts to help you rearrange the split tabs automatically into a horizontal, vertical, or grid layout.
