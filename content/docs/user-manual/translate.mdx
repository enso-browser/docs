...
Enso detects the page languages manually and will suggest to translate it to your preferred languages. You can use the "**Translate from**" dropdown menu to change page language to detect, and use the "**Translate to**" dropdown menu to change your translation output language. Select "**Translate**" to translate the entire page.

<Callout>
Enso will download the language first if you're using this feature for the first time. After the language is downloaded, translation process will take around 20-60 seconds, depend on the length of contents.
</Callout>
...
Enso lets you set separate languages for displaying user interface (menu, messages, notifications) and webpages, accessible from `Settings` > `General` > `Language & Appearance` > `Language`. 
...
Here are the languages that currently supported for translating webpages in Enso:
- Arabic
- Bulgarian
- Chinese (Simplified)
- Catalan
