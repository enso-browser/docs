...
At the moment, our team does not have the time or resources to develop Android or iOS versions of Enso Browser. Additionally, we believe that Zen’s unique features, particularly its design around vertical tabs, do not translate well to the mobile form factor. As such, we do not currently have plans to develop a mobile version of Enso Browser.
...
1. Go to your profiles folder (Linux: `~/.zen/` or Flatpak: `~/.var/app/app.enso_browser.zen/zen/`, Windows: `%APPDATA%/zen/Profiles`)
